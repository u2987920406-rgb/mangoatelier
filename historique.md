...
- **#51 — Sharingan-sur-image** (`S · ⚖️ Sonnet`) : appliquer l'extraction design de Sharingan (`cssColorToHex`/`dedupeColors`, déjà dans `vision.ts`) à une **photo jointe**, pas qu'à une URL → palette/ambiance structurées. Unifie URL ↔ image. Petit effort, complète #46/#47.
