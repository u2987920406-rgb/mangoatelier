...
- **Plan de formation & développement** : `PLAN-FORMATION.md` — 26 idées, 6 phases, timing, checkboxes, guides pour les projets formation. À relire au démarrage de session et à tenir à jour (cocher les cases au fur et à mesure). **Idées 12 (MVP/Élite) ✅ et 16 (GitHub natif) ✅ faites — prochaine étape : Idée 17 (Supabase). ⚠ Le push GitHub réel reste à tester : l'utilisateur doit ajouter `GITHUB_TOKEN` (scope `repo`) dans `server/.env`**
