...
- **Plan de formation & développement** : `PLAN-FORMATION.md` — 26 idées, 6 phases, timing, checkboxes, guides pour les projets formation. À relire au démarrage de session et à tenir à jour (cocher les cases au fur et à mesure). **Idée 12 (Sélecteur MVP/Élite) FAITE ✅ — prochaine étape : Idée 16 (GitHub natif) ou 17 (Supabase)**
