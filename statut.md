...
*Dernière mise à jour : 2026-06-15 — Vague 6 : phases 1 des idées #26 (multi-projets) & #40 (super-agent) ✅, livrées en parallèle.*
...
| 26 | Mode multi-projets & composition | 🚧 P1 ✅ (P2/P3 restantes) | ⚖️→🧠 | M+L |
...
| 40 | Invocation super-agent spécialisé | 🚧 P1 ✅ (P2/P3 restantes) | ⚖️→🧠 | M+L |
