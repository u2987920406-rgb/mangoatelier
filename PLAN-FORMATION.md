...
- [x] **Idée 17 · Intégration Supabase** 🔧 *Type A — FAIT & VALIDÉ EN LIVE (2026-06-13)*
  - L'agent génère le code Supabase (client, SQL + RLS) ✅
  - App `todo-supabase` testée : tâches réellement persistées dans le cloud ✅
  - Sécurité : `.env` git-ignoré + hors zip (clés protégées) ✅
  - Compte + clés en place (`.credentials/supabase.md`)
  - **Statut :** ✅ FAIT & VALIDÉ — comble le manque vs Lovable
