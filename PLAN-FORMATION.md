...
- [x] **Idée 16 · Intégration GitHub native** 🔧 *Type A — FAIT & VALIDÉ (2026-06-13)*
  - Push vers un repo GitHub en 1 clic depuis MangoAI ✅
  - Bouton "GitHub"/"Push" + chip vers le repo dans le header ✅
  - Token utilisateur en place dans `server/.env`, push réel testé avec succès
    (repo privé `test-pipeline` créé, remote propre, zéro secret versionné) ✅
  - **Statut :** ✅ FAIT & VALIDÉ
...
- Validations : GitHub ✅ testé (push réel OK). Reste Supabase (clés dans le `.env` d'un projet) si tu veux le valider, et voir Mango Plan/blueprints en action.
