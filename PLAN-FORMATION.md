...
**→ Idée 16 · Intégration GitHub native** (Phase 1, suite) — chaque projet devient un vrai repo.
*Ou* enchaîner directement sur **Idée 17 · Supabase** (le vrai manque vs Lovable).
*Ou* pour ta formation : ouvrir MangoAI et construire le **Visualiseur de tokens (idée 20)** — voir le guide Phase 3.

*L'idée 12 (sélecteur MVP/Élite) est faite ✅ — l'interrupteur est posé, toutes les fonctions suivantes s'y brancheront.*
