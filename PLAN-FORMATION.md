...
**→ Idée 17 · Intégration Supabase** (Phase 1, dernière brique) — le vrai manque vs Lovable : apps avec base de données et authentification.
*Avant ça* : valide le push GitHub (idée 16) en ajoutant ton `GITHUB_TOKEN` dans `server/.env`.
*Ou* pour ta formation : ouvrir MangoAI et construire le **Visualiseur de tokens (idée 20)** — voir le guide Phase 3.

*Idées 12 (sélecteur MVP/Élite) ✅ et 16 (GitHub natif) ✅ faites — Phase 1 presque bouclée (reste Supabase).*
